...
export default function HomeSection() {
  return (
    <section className="bg-black pb-60 md:p-0 ">
      <div className="relative w-full bg-[url('/images/home/hero-bg.png')] bg-cover bg-center min-h-[70vh] lg:min-h-[80vh] ">
      ...
      transform: translate(-50%, -50%) */}
        ...
        <div className="absolute left-1/2 top-[75%] lg:bottom-[-60px] transform -translate-x-1/2 w-[90%] sm:w-[80%]">
