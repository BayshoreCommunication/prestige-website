  ...
  return (
    <section className="relative px-8 w-full  mx-auto">
      ...
      <div className="absolute inset-0">
        <Image
          src="images/testimonialspage/testimonials/bg.png"
          alt="About Us Background"
          width={1000}
          height={800}
          className="object-cover object-top brightness-60 w-full h-full"
          priority
        />
      ...
      <div className="relative z-20 flex flex-col justify-center items-start min-h-[300px] md:min-h-[400px] text-white space-y-4 max-w-[1640px] mx-auto">
        <h1 className="text-3xl md:text-5xl font-bold text-black">Testimonials</h1>
