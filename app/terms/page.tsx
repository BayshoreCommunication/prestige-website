...
export const metadata: Metadata = {
  title: "Terms of Service | Prestige Medical & Physical Therapy",
  description:
    "Read the terms of service and usage conditions for Prestige Medical & Physical Therapy's website.",
  alternates: {
    canonical: "/terms",
  },
};
